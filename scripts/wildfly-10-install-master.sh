...
sudo cp /vagrant/scripts/start-wildfly-10-master.sh start-wildfly-10-master.sh
sudo chmod 777 start-wildfly-10-master.sh
dos2unix start-wildfly-10-master.sh start-wildfly-10-master.sh
