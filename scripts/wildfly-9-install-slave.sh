...
sudo cp /vagrant/scripts/start-wildfly-9-slave.sh start-wildfly-9-slave.sh
sudo chmod 777 start-wildfly-9-slave.sh
dos2unix start-wildfly-9-slave.sh start-wildfly-9-slave.sh
