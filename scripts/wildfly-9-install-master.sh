...
sudo cp /vagrant/scripts/start-wildfly-9-master.sh start-wildfly-9-master.sh
sudo chmod 777 start-wildfly-9-master.sh
dos2unix start-wildfly-9-master.sh start-wildfly-9-master.sh
