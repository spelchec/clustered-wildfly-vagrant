...
sudo cp /vagrant/configuration/wildfly9/wildfly.conf .
sudo cp /vagrant/configuration/wildfly9/standalone-ha.xml standalone-ha.xml
...
sudo cp /vagrant/scripts/start-wildfly-9-slave2.sh start-wildfly-9-slave2.sh
sudo chmod 777 start-wildfly-9-slave2.sh
dos2unix start-wildfly-9-slave2.sh start-wildfly-9-slave2.sh
