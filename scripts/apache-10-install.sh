...
sudo cp /vagrant/scripts/wildfly-10-install-master.sh wildfly-10-install-master.sh
sudo chmod 777 wildfly-10-install-master.sh
dos2unix wildfly-10-install-master.sh wildfly-10-install-master.sh
